...
export function Footer() {
  return <footer className="mt-20 bg-slate-950 text-slate-300"><div className="container-shell grid gap-10 py-14 md:grid-cols-4">
    ...
    <div><h4 className="font-semibold text-white">Company</h4><div className="mt-3 space-y-2 text-sm"><Link href="/about" className="block">About</Link><Link href="/contact" className="block">Contact</Link><Link href="#" className="block">Supplier onboarding</Link></div></div>
    <div><h4 className="font-semibold text-white">Support</h4><p className="mt-3 text-sm">Accra, Ghana<br/>support@buildmate.example<br/>+233 00 000 0000</p></div>
