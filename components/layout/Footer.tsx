  ...
  return (
    <footer className="mt-20 bg-slate-950 text-slate-300">
      <div className="container-shell grid gap-10 py-14 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm leading-6">
            Verified materials, transparent quotations and coordinated delivery
        ...
        <div>
          ...
          <div className="mt-3 space-y-2 text-sm">
            ...
            <Link className="block" href="/refunds">
              Refunds & disputes
            </Link>
            <Link className="block" href="/acceptable-use">
              Acceptable use
            </Link>
          </div>
        </div>
      ...
      <div className="border-t border-slate-800 py-5 text-center text-xs">
        © {new Date().getFullYear()} BuildMate Ghana. All rights reserved.
      </div>
    </footer>
  );
}
