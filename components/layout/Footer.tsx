...
export function Footer() {
  return <footer className="mt-20 bg-slate-950 text-slate-300"><div className="container-shell grid gap-10 py-14 md:grid-cols-4">
    <div><BrandLogo inverse /><p className="mt-3 text-sm leading-6">Verified materials, transparent quotations and coordinated delivery for every building project.</p></div>
